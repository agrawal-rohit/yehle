...
function renderCodexOrOpenCodeRule(ruleContent: string, ruleName: string): {
	target: string;
	content: string;
} {
	...
	return {
		target: "AGENTS.md",
		content: `<!-- Generated by yehle agent-instructions (${ruleName}); do not edit by hand. -->\n\n${body}`,
	};
}
...
export function renderAgentRule(
	...
	switch (codingAgentIDE) {
		...
		case "codex":
		case "opencode":
			return renderCodexOrOpenCodeRule(ruleContent, ruleName);
		default: {
